...
class FireworkYearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create firework_year" do
    assert_difference('FireworkYear.count') do
      post firework_years_url, params: { firework_year: { cost: @firework_year.cost, firework_id: @firework_year.firework_id, purchased: @firework_year.purchased, year: @firework_year.year } }
    end
  ...
  test "should update firework_year" do
    patch firework_year_url(@firework_year), params: { firework_year: { cost: @firework_year.cost, firework_id: @firework_year.firework_id, purchased: @firework_year.purchased, year: @firework_year.year } }
