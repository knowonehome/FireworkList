...
class FireworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create firework" do
    assert_difference('Firework.count') do
      post fireworks_url, params: { firework: { description: @firework.description, firework_name: @firework.firework_name, style: @firework.style } }
    end
  ...
  test "should update firework" do
    patch firework_url(@firework), params: { firework: { description: @firework.description, firework_name: @firework.firework_name, style: @firework.style } }
